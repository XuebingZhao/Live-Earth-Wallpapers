...
class PlanetDialog(QDialog, Ui_Dialog):
    ...
    def get_values(self):
        planet_group = "geostationary" if self.satellite_selector.currentText() in ["goes-19","goes-18","himawari","gk2a","meteosat-9","meteosat-0deg"] else self.satellite_selector.currentText()
        all_values = {}
