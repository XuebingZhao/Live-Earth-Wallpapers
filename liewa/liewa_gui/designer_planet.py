...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.satellite_selector.setItemText(4, _translate("Dialog", "himawari"))
        self.satellite_selector.setItemText(5, _translate("Dialog", "gk2a"))
        self.satellite_selector.setItemText(6, _translate("Dialog", "sdo"))
        self.satellite_selector.setItemText(7, _translate("Dialog", "apod"))
        self.satellite_selector.setItemText(8, _translate("Dialog", "sentinel"))
